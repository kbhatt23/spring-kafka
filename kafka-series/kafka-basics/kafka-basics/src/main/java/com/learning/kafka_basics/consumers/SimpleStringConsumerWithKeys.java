...
public class SimpleStringConsumerWithKeys {
	...
	public static void main(String[] args) {
		...
		properties.put(ConsumerConfig.GROUP_ID_CONFIG, "simple-string-multi-group-new");
		properties.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
		
		
		KafkaConsumer<String, String> consumer = new KafkaConsumer<>(properties);
		
		consumer.subscribe(Arrays.asList("simple-string-keys-multi"));
