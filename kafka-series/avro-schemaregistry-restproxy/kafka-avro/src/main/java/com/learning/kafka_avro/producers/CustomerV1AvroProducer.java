...
public class CustomerV1AvroProducer {

	private static final String BASIC_AVRO_TOPIC = "customer-avro-topic";
	private static KafkaProducer<String, CustomerV1> producer;
	...
	public static void main(String[] args) {
		...
		CustomerV1 customer = CustomerV1.newBuilder().setFirstName("krishna").setLastName("kanhayya").setAge(101)
				.setAutomatedEmail(true).setHeight(199.99f).setWeight(999.99f).build();
		ProducerRecord<String, CustomerV1> producerRecord = new ProducerRecord<>(BASIC_AVRO_TOPIC, customer);
